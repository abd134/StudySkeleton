...
public class ConfirmationMain {
    Context mContext;
     ...
     public String initializeRegistration(String initVars){
         //TODO: use initVars that are produced by initializeRegistration on the server to generate required keypair
         // Return the certificateChain as a single string which will be sent to the server
         return "";
     ...
     public String displayConfirmationPrompt(String promptDetails){
         ...
         // promptDetails is the string returned by the initializeTransaction function on the server.
